        ...
        <header className="navbar navbar-top navbar-expand flex-row">
          ...
          <ul className="navbar-nav flex-row ml-auto">
            ...
            <li className="nav-item">
              <a
                className="nav-link"
                href="https://github.com/darkwood-fr/serverless-starter"
                target="_blank"
            ...
            <li className="nav-item">
              <a
                className="nav-link"
                href="https://twitter.com/serverless-starter"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Twitter"
              >
        ...
        render={({site: {siteMetadata}, logo, logoSeo, changeLogTags}) => (
          <>
            <Helmet>
              ...
              <meta name="twitter:site" content="serverless-starter_io"/>
